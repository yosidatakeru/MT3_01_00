...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Matrix4x4 perspectiveFovMatriix = MakePectiveFovMatrix(0.63f, 1.33f, 0.1f, 1000.0f);
	...
	while (Novice::ProcessMessage() == 0) {
		...
		MatrixScreenPrintf(0, 80, perspectiveFovMatriix);
		MatrixScreenPrintf(0, 160, viewporMatrix);
		///
		/// ↑描画処理ここまで
		///
